    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          ...
          <div className="p-3 sm:p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
            <div className="flex items-center gap-1 mb-1">
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Costo total</p>
          ...
          <div className="p-3 sm:p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
            <div className="flex items-center gap-1 mb-1">
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Plazo Real</p>
      ...
      <Card title="Desglose de Costos">
        <div className="space-y-2 sm:space-y-3">
          <div className="flex justify-between items-center py-1.5 sm:py-2 border-b border-gray-200 dark:border-gray-700">
            <span className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Principal</span>
            <span className="text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100">
              {formatCurrency(principal)}
            </span>
          </div>
          <div className="flex justify-between items-center py-1.5 sm:py-2 border-b border-gray-200 dark:border-gray-700">
            <span className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Total Pagado</span>
            <span className="text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100">
              {formatCurrency(summary.totalPaid)}
            </span>
          </div>
